...
\begin{table}[h]
	...
	\begin{tabular}{>{\bfseries}l | r r r | r r r}
		\toprule
			...
			& \bfseries Parametric & \bfseries Contextual & \bfseries Other & \bfseries Parametric & \bfseries Contextual & \bfseries Other \\
		\midrule
			mean & 1.34 & 1.16 & 1.63 & 1.38 & 1.18 & 1.45 \\
			std  & 0.35 & 0.23 & 0.77 & 0.38 & 0.27 & 0.53 \\
			25\% & 1.13 & 1.04 & 1.24 & 1.14 & 1.05 & 1.17 \\
			50\% & 1.23 & 1.09 & 1.39 & 1.26 & 1.10 & 1.29 \\
			75\% & 1.43 & 1.18 & 1.68 & 1.50 & 1.20 & 1.46 \\
		\bottomrule
	\end{tabular}
...
\begin{table}[h]
	...
	\begin{tabular}{>{\bfseries}l | r r r | r r r}
		\toprule
			...
			& \bfseries Parametric & \bfseries Contextual & \bfseries Other & \bfseries Parametric & \bfseries Contextual & \bfseries Other \\
		\midrule
			mean & 2.41 & 1.90 &  6.44 & 10.31 & 1.93 & 3.48 \\
			std  & 1.06 & 1.53 & 12.44 & 16.99 & 5.61 & 6.50 \\
			25\% & 1.50 & 1.21 &  2.55 &  1.10 & 1.02 & 1.22 \\
			50\% & 2.29 & 1.41 &  3.39 &  1.52 & 1.09 & 1.93 \\
			75\% & 3.15 & 1.85 &  6.97 &  7.21 & 1.28 & 3.30 \\
		\bottomrule
	\end{tabular}
