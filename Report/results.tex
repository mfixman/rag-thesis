...
\subsubsection{Calculating the attention of the contextual and question part of each query}
\label{attention_results}

Using the method described in \cref{attention_section}, we can find how much attention each model gives, on average, to the context part of the query and to the rest.
...
\begin{table}[ht]
	...
	\begin{tabular}{l | r r r r}
		\toprule
			Query Part & \smallflan{} & \bigflan{} & \llamapar{} & \bigllamapar{} \\
		\midrule
			Context & 0.18 & 0.22 & 0.08 & \\
			Rest & 0.38 & 0.05 & 0.29 & \\
		\bottomrule
	\end{tabular}
	\caption{Average normalised attention of the query on the tokens corresponding to the context of the query, and to the tokens corresponding to the rest.}
