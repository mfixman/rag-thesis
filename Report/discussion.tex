...
Does the type and size of the model affect the distribution of each type of \Other{} answer?
\Cref{other_results_category} contains the amount of answers per type for each one of the models, and there does not seem to be a particular distribution.
