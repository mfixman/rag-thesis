...
We can prove this hypothesis by finding the average attention of the model on the cases where the Seq2Seq and Decoder-only models disagree, using the method discussed in \cref{attention_section}.
...
While the average results are very similar, which is likely due to the properties of Seq2Seq models discussed in \cref{model_architecture_parametric}, the models seem to be significantly different for 
