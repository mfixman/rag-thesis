...
To address these items, we follow the approach done by \citeauthor{factual_recall} in creating base questions that refer to a specific object, so all the answers for the same base question have a similar format and creating counterfactual answers is easy.
...
This approach is detailed in \cref{action_diagram}, and \cref{counterparametric_table} contains an example of the shuffling done for this experiment.
