...
\Cref{total_table} showed that a significant minority of responses to queries with counterfactual context are \Other{}: answers given by the model that aren't equal to either the parametric nor the contextual answer.
