...
% The four models can be found in \cref{total_table,total_results}.
...
\begin{table*}[ht]
	...
	\begin{tabular}{>{\bfseries}l | r r r | r r r}
		...
		\bottomrule \addlinespace[4pt]
	\end{tabular}
	\caption{Results for running each one of the 10 categories separately. \todo{Should this be a percentage? Is this relevant at all?}}
	\label{cats_table}
\end{table*}
